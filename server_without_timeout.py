...
from flask import Flask, request, Response #Imports necessary flask libs
...
#d = {}
@app.route('/bbb', methods=['POST']) #Same thing as above, except this is what Flask should do when a POST request is made to this URL
def get_tags():
	#TODO: Error checking
#       global d 
#       d = {}
